...
('e9dc96f3-6691-4a7c-9d6c-ef3b367ad6f1', 'patient', 'Test Patient', 'test.patient@example.com'),
('f7dc96f3-6691-4a7c-9d6c-ef3b367ad6f2', 'nurse', 'Test Nurse', 'test.nurse@example.com')
ON CONFLICT (id) DO NOTHING;
